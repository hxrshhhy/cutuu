...
function drawText() {
  ...
  if (frameNumber < 300) {
    ...
    context.fillText(
      "From day one, you've filled my life with love and joy",
      canvas.width / 2,
      canvas.height / 2
    );
  ...
  if (frameNumber > 1200 && frameNumber < 1500) {
    context.fillStyle = `rgba(255, 255, 255, ${opacity})`;
    context.fillText(
      "You've been the brightest light in my life since day one",
      canvas.width / 2,
      canvas.height / 2
    );
    opacity = opacity + 0.01;
  ...
  if (frameNumber > 2400 && frameNumber < 2700) {
    ...
    if (window.innerWidth < 600) {
      drawTextWithLineBreaks(
        [
          "With each passing day, my love for you grows stronger",
  ...
  if (frameNumber > 3000 && frameNumber < 99999) {
    ...
    if (window.innerWidth < 600) {
      drawTextWithLineBreaks(
        [
          "Maitri I love you so much , more than",
      ...
      context.fillText(
        "Maitri I love you so much , more than all the time and space in the universe can contain",
        canvas.width / 2,
        canvas.height / 2
      );
    }
  ...
  if (frameNumber >= 3600 && frameNumber < 99999) {
    ...
    context.fillText(
      "Will You Be Mine?(YOU DON'T HAVE ANY OTHER OPTION)",
      canvas.width / 2,
      canvas.height / 2 + 120
    );
